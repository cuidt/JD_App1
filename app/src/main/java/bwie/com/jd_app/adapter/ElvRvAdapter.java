...
public class ElvRvAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    private List<RightBean.DataBean.ListBean> listBeen;
    //2、定义一个属性
    ...
    public ElvRvAdapter(Context context, List<RightBean.DataBean.ListBean> listBeen) {
    ...
    public void onBindViewHolder(RecyclerView.ViewHolder holder, int position) {
        final RightBean.DataBean.ListBean listBean = listBeen.get(position);
